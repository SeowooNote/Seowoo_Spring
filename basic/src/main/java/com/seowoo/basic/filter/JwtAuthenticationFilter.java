package com.seowoo.basic.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private String parseBearerToken(HttpServletRequest request) {
    ...
    // description: Authorization 키와 값이 존재하는지 검증 //
    boolean hasAuthorziation = StringUtils.hasText(authorization);
    if (!hasAuthorziation) return null;

    // description: Authorizaition 값이 Bearer Token 인지 검증 //
